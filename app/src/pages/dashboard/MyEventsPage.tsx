            ...
            {loading ? (
                ...
                registeredEvents.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-white/5 rounded-2xl border border-dashed border-white/10">
                        ...
                        <p className="text-gray-400 mb-6">You haven't registered for any events. Head over to Discovery to find upcoming tournaments.</p>
                        <button 
                            onClick={() => navigate('/dashboard/events')}
                            className="bg-lime-400 hover:bg-lime-500 text-[#0f172a] font-semibold px-6 py-2 rounded-lg transition-colors"
                        >
                            Browse Events
                        </button>
                    </div>
