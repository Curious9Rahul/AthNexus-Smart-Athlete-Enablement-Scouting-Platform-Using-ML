...
import { Calendar as CalendarIcon, MapPin, Trophy, Clock, Users } from 'lucide-react';
...
const EventCard = ({ event, onRegisterSuccess }: EventCardProps) => {
    ...
    const handleRegister = async () => {
        ...
        const success = await registerForEvent(event.id, {
            athleteId: user.email, // using email as id for simplicity since we don't have true db ids
                ...
                <div className="mt-auto">
                    {regStatus === 'APPROVED' ? (
                        ...
                        <button 
                            ...
                            className="w-full py-3 bg-lime-400 text-[#0f172a] hover:bg-lime-500 font-black rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-lime-400/10 text-sm uppercase tracking-wider active:scale-95"
                        >
